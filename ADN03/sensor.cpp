...
const char* Create_Resp(Response Resp)
{
    ...
    switch(RES.Resource_Type){
        ...
        case 13:
            ...
            demo2["rsc"] = RES.responseStatusCode;
    ...
    demo["rqi"] = RES.Request_Identifier;
    demo["op"] = RES.Operation;
    demo["ty"] = RES.Resource_Type;
    //demo["to"] = Resp.To;
    //demo["fr"] = Resp.From;
    //demo["lcl"] = lcl;
...
const char* DM_Resp(Response Resp) // DevID, Man, Mod, DevType, FwV, SwV, HwV
{
    ...
    switch(RES.Resource_Type){
        ...
        case 13:
            ...
            demo2["FwV"] = RES.FirmwareVersion; 
            demo2["SwV"] = RES.SoftwareVersion;
...
const char* DM_Resp2(Response Resp) // DevID, Man, Mod, DevType, FwV, SwV, HwV
{
    MbedJSONValue demo, demo2, demo3, demo4;
    std::string s;
    ...
    switch(RES.Resource_Type){
        ...
        break;
        case 13:
            demo2["Man"] = RES.Manufacturer;
            demo2["Mod"] = RES.Model;
            demo2["DevType"] = RES.DeviceType;
            demo2["HwV"] = RES.HardwareVersion;
            demo2["ri"] = RES.resourceID;
            demo2["pi"] = RES.parentID;
            demo2["ct"] = RES.creationTime;       //ct     1
            demo2["et"] = RES.expirationTime;     //et     1  
