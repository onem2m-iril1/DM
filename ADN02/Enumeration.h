...
bool rr, local;   
std::string From, csi, api, poa,to, rqi, aei, rn, mma, mmt,mgd;
std::string DevID, Man, Mod, DevType, FwV, SwV, HwV;
std::string ri, pi, ct, et, lt, dmma, dmmt;
char URI[40];
char* c_aei;
std::string con, cnf;
std::string nu;
...
extern struct CreateMGO MGO;
extern struct respmgo RMG;
...
void resource_type()
{
    switch (ty)
    {
        ...
        content = "m2m:mgc";
        break;
        case 13: //device management json need
